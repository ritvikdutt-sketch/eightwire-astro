...
![Run a Process (screenshot)](./images/execute-a-process-5.webp)
...
![Stop a Process execution (screenshot)](./images/execute-a-process-6.webp)

Double click on the process — a running process will be blue.

![Stop a Process execution (screenshot)](./images/execute-a-process-7.webp)

Click the **Stop** button.

![Stop a Process execution (screenshot)](./images/execute-a-process-8.webp)

In the activity page the process that has been stopped will appear with the red icon.

![Stop a Process execution (screenshot)](./images/execute-a-process-9.webp)
...
![Run a Process Group (screenshot)](./images/execute-a-process-10.webp)
...
![Run a Process Group (screenshot)](./images/execute-a-process-11.webp)
