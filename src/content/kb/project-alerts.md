...
description: "Configure email notifications for events within specific Projects using Project Alerts.. This allows you to be notified about connectivity of Datastores and the execution of Processes without needing to log in to Eightwire."
category: "Account and Project Alerts"
order: 29
sourceUrl: "https://www.eightwire.io/knowledge-base/project-alerts"
---

Navigate to **Project Alerts** from the Quick Access menu on the **Project** dashboard.

![Project Alerts (screenshot)](./images/project-alerts-1.webp)

Select an event threshold to apply to the selected Alert options;

![Project Alerts (screenshot)](./images/project-alerts-2.webp)

For an Alert option, toggle to ON and enter any email addresses for notifications.

![Project Alerts (screenshot)](./images/project-alerts-3.webp)
...
![Project Alerts (screenshot)](./images/project-alerts-4.webp)
...
![Project Alerts (screenshot)](./images/account-alerts-6.webp)

![Project Alerts (screenshot)](./images/account-alerts-7.webp)
